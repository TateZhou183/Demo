            ...
            <%
                if (user == null) {
                    ...
                    out.println("<li><a><span class=\"glyphicon glyphicon-user\"></span>" + user.getNickName() + "</a></li>" +
                            ...
                            "<li><a href=\"/ShoppingOnline/shopCar.jsp\"><span class=\"glyphicon glyphicon-shopping-cart\"></span>查看购物车</a></li>" +
                            "<li><a href=\"/ShoppingOnline/order.jsp\"><span class=\"glyphicon glyphicon-certificate\"></span>我的订单</a></li>"
                    );
                }
            %>
