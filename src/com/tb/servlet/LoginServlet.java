...
import com.tb.bean.User;
import com.tb.service.PublicService;
...
public class LoginServlet extends HttpServlet {
    ...
    private void adminLog(HttpServletRequest req, HttpServletResponse resp, PublicService ps) throws IOException, ServletException {
        ...
        if (logUser != null) {
            ...
            resp.sendRedirect("/ShoppingOnline/admin.jsp");
        } else {
            req.setAttribute("login_info", "µÇÂ¼Ê§°Ü");
            req.getRequestDispatcher("/ShoppingOnline/admin_log.jsp").forward(req, resp);
        }
    }
    ...
    private void userLog(HttpServletRequest req, HttpServletResponse resp, PublicService ps) throws IOException, ServletException {
        ...
        if (logUser != null) {
            ...
            resp.sendRedirect("/ShoppingOnline/index.jsp");
        } else {
            req.setAttribute("login_info", "µÇÂ¼Ê§°Ü");
            req.getRequestDispatcher("/ShoppingOnline/log.jsp").forward(req, resp);
        }
    }
